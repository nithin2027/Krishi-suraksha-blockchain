...
import style from "./launched-app.module.css"; // Import the CSS file

import tokenAbi from '../abi/mintToken.json';

export default function Launch() {
  // css is same but  Navbar is different
  ...
  return (
    <div className={`${style.launchApp} landingContainer`} style={{backgroundImage: `url('https://img.freepik.com/free-photo/detail-rice-plant-sunset-valencia-with-plantation-out-focus-rice-grains-plant-seed_181624-25838.jpg')`}}>
