...
import CompanyPolicy1 from "./Company-Policy-1";
import CompanyPolicy2 from "./Company-Policy-2";

export default function CompanyPolicies({ account, webApi }) {
    ...
    function viewPolicy() {
        function viewPolicy1() {
            if (policy1) {
                return (
                    <>
                        <CompanyPolicy1 account={account} webApi={webApi} />
                    </>
                );
            }
        }
        ...
        function viewPolicy2() {
            if (policy2) {
                return (
                    <>
                        <CompanyPolicy2 account={account} webApi={webApi} />
                    </>
                );
            }
        }
