...
export default function CompanyPolicy2({ account, webApi }) {
    return (
        <>
            <div className="w-5/6 m-auto">
                <p className="md:mt-2 md:text-4xl text-center text-2xl xs:text-base text-orange-900 mt-4 font-bold">2st POLICY (6 MONTHS)</p>
                ...
                <Popup
                    ...
                    modal nested
                >{
                        close => (<CompanyForm account={account} webApi={webApi} months={4} />)
                    }
